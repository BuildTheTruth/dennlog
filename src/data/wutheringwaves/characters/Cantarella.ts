...
const weapons: Wutheringwaves.Weapon[] = [
  {
    ...
    priority: 1,
    mainStat: '공격력 500 / 크리티컬 피해 72%',
    subStat: '공격력 12% / 일반 공격 피해 증가 40% / 적 인멸 저항 무시 12%',
  },
  {
    ...
    priority: 2,
    mainStat: '공격력 500 / 크리티컬 피해 72%',
    subStat: '공격력 12% / 일반 공격 피해 증가 36% / 미출전 일반 공격 피해 증가 52%',
  },
  {
    id: 'CosmicRipples',
    name: '파도의 기록',
    ...
    priority: 3,
    mainStat: '공격력 500 / 공격력 54%',
    subStat: '공명효율 12.8% / 일반 공격 피해 증가 16%',
  },
  {
    id: 'Augment',
    name: '청음',
